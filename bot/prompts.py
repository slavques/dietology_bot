...
GOAL_REMINDER_MORNING_PROMPT = (
    ...
    "Сделай короткое сообщение ≤220 символов. Начни с 1 эмодзи.\n"
    ...
    "- Используй обозначения К, Б, Ж, У при упоминании цифр.\n"
...
GOAL_REMINDER_EVENING_PROMPT = (
    ...
    "Сделай короткий ответ ≤300 символов.\n"
    "Данные: цель={goal}; план=К{plan_kcal}/Б{plan_P}/Ж{plan_F}/У{plan_C};\n"
    ...
    "- Во втором абзаце — обязательно укажи цель в формате: "
    "'Твоя цель {plan_kcal} ккал / {plan_P} Б / {plan_F} Ж / {plan_C} У'.\n"
