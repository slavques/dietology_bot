...
PRO_HINT_PROMPT_BASE = (
    "Ты — диетолог. Пользователь пишет уточнение после анализа фото или текста — {context}\n"
    "{hints}Теперь пользователь прислал уточнение: «{hint}».\n\n"
    "Если уточнение относится к еде или напитку, обнови данные по запросу пользователя — название, вес и КБЖУ.\n"
    "Если указан бренд или производитель, найди точные КБЖУ на fatsecret.ru (значения до десятых) и используй массу всей порции.\n"
