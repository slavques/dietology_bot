...
REFERRAL_SHARE = (
    ...
    "Вот твой шанс попробовать бесплатно 5 дней: {link}"
)

REFERRAL_WELCOME = (
    "🥑 Ты пришёл по приглашению друга и получил 5 дней пробной подписки бесплатно 🎁\n\n"
    "С Nomnomly ты сможешь по фото определять калории и БЖУ, вести дневник питания и формировать полезные привычки.\n\n"
    "📸 Чтобы активировать бонус и подарить другу +7 дней — просто отправь фото любого блюда или продукта."
)
