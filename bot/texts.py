...
MANUAL_PROMPT = "Введите описание блюда или напитка"
MANUAL_ERROR = "Не удалось распознать описание"
...
TRIAL_STARTED = "Тебе подключён тариф {grade} на {days} {day_word} бесплатно!"
TRIAL_ENDED = (
...
STATS_MENU_TEXT = "Выберите раздел статистики:"
STATS_TOTALS = (
    "Всего за период:\n"
...
# Subscription texts
SUB_INVALID_PLAN = "Чтобы оформить подписку, используйте команду /success1467 или свяжитесь с поддержкой."
SUB_METHOD_TEXT = (
