...
REM_TEXT_MORNING = "🌞 Доброе утро! Что вкусного на завтрак? Не забудь сфоткать еду 📸"
REM_TEXT_DAY = "🍲 Время обеда! Если ещё не поел — пора! Жду фото обеда 😉"
REM_TEXT_EVENING = "🌙 Ужин уже на столе? Покажи, чем себя радуешь вечером! 📷"
